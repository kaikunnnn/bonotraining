        ...
        <div className="!w-full max-w-4xl mx-auto px-4 py-14  overflow-hidden">
          <div className="w-full flex-col justify-center items-start gap-8 flex">
            <div className="w-full flex-col justify-start items-start gap-6 flex">
              <div className="w-full flex-col justify-start items-start gap-2 flex">
                ...
                <div className="text-foreground text-2xl md:text-[32px]">{title}</div>
              </div>
            </div>
          ...
          <div className="w-full pb-7 flex-col justify-center items-start flex">
            {items.map((item, index) => (
              <div key={index} className="w-full py-8 border-b border-foreground/20 flex flex-col md:flex-row justify-start items-start md:items-center gap-5">
                  ...
                  <div className="justify-start items-center gap-2 inline-flex">
                    ...
                    <div className="h-5 justify-start items-center gap-2 flex">
                      <div className="px-3 py-0.5 bg-foreground/10 rounded-2xl flex-col justify-start items-center gap-2.5 inline-flex">
                        <div className="text-foreground text-xs">{String(item.step).padStart(2, '0')}</div>
                      </div>
                    </div>
                  </div>
                  <div className="self-stretch text-foreground text-xl md:text-2xl">{item.title}</div>
                </div>
                <div className="w-full md:flex-1 flex-col justify-center items-start gap-5 flex">
                  <div className="w-full text-foreground text-base">{item.subtitle}</div>
                  <div className="w-full text-foreground/80 text-sm">{item.description}</div>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="w-full max-w-[800px] flex flex-col items-center">
              <div className="w-full flex flex-col items-center gap-8">
                <div className="w-full aspect-[1.62] relative mt-4">
                  <img className="w-full h-full object-contain" src={exercise.thumbnail} alt={exercise.title} />
                </div>
                <div className="flex items-start gap-2">
                  <div className="text-[#0d0f18] text-sm font-bold font-['Rounded Mplus 1c Bold'] leading-[14px] tracking-wide">難易度</div>
                  <div className="text-[#0d0f18] text-sm font-bold font-['Rounded Mplus 1c Bold'] leading-[14px] tracking-wide">{exercise.difficulty}</div>
                </div>
                <h1 className="text-center text-[#0d0f18] text-5xl font-bold font-['Rounded Mplus 1c Bold'] leading-[1.4] tracking-wide">
                  {exercise.title}</h1>
                <div className="flex flex-col items-center gap-2.5">
                  <div className="text-[#0d0f18] text-base font-normal font-['Rounded Mplus 1c'] leading-relaxed tracking-wide">{exercise.description}</div>
                  <div className="flex items-center gap-5">
                    <div className="justify-start items-center gap-1 flex">
                      ...
                      <div className="justify-center items-start flex">
                        <div className="text-center text-[#0d0f18] text-sm font-medium font-['Rounded Mplus 1c'] leading-tight">{exercise.category}</div>
                      </div>
                    </div>
                    <div className="justify-start items-center gap-1 flex">
                      <div className="px-1 bg-[#eaf3ef] rounded-md justify-center items-center gap-2.5 flex">
                      ...
                      <div className="justify-center items-start flex">
                        <div className="text-center text-[#0d0f18] text-sm font-medium font-['Rounded Mplus 1c'] leading-tight">{exercise.type}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div key={index} className="w-full">
                    ...
                    >
                      <div className="flex-shrink-0 px-4 py-2 flex flex-col items-center">
                        ...
                        <div className="text-[#0d211d] text-[32px] font-semibold font-['Phudu'] leading-loose">{String(index + 1).padStart(2, '0')}</div>
                      </div>
                      <div className="flex-grow text-[#0d211d] text-xl font-bold font-['Noto Sans JP'] leading-loose tracking-wide">{stage.title}</div>
