...
export const exercisesData: { [key: string]: Exercise } = {
    "exercise-1": {
        ...
        category: "UIビジュアル",
        type: "チャレンジ",
        thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyIEyfClNU0SVPqlWPYBvqUG3JjBr-Orm3dw&s",
        stages: [
            { id: 1, title: "説明" },
            { id: 2, title: "説明" },
            { id: 3, title: "説明" },
        ...
        benefits: [
            {
                ...
                description: "「麻布大学人材バンク」は、研究者が研究時間を確保することを目的に作られました。事務処理業務や研究補助業務等を地域の方や学生にお願いすることにより、研究効率の向上を図れます。"
            },
            {
                step: 2,
                title: "デザインシステムを理解しよう",
                subtitle: "一貫性のあるUIデザインの作り方",
                description: "デザインシステムの基本概念と実践的な適用方法について学びます。"
            }
        ],
        howTo: [
            {
        ...
        knowledge: [
            {
                ...
                title: "UIデザインの基礎",
                subtitle: "基本的なデザイン原則",
                description: "ユーザーインターフェースデザインの基本原則について学びます。"
            },
            {
                step: 2,
                title: "レイアウトの考え方",
